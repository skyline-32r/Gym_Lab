...
(539, 999, 2, 'try again', '2023-10-16', 4);
...
(999, 'Team1', 'private', '1998-03-18', '台北市大安區', '復興南路一段390號2樓', '0912345678', 3, NULL, 'ispanTeam1@gmail.com', '$2a$10$.LJKZejhJGLMl1Ln6DTaEe8.NbxQKx3CeyOeh0X6ZKvMWYH/IykKC', '2023-10-11 16:33:27', 0, 0, 'unlocked');
...
--
ALTER TABLE `course_cart`
  MODIFY `course_cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `course_reviews`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=540;
